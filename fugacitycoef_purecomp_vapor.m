...
% -------------------------------------------------------------------------
% In this function, the maximum z-factor is chosen if multiple roots are
% found.
function [fugcoef, zfactor] = fugacitycoef_purecomp_vapor(press, temp, pressc, tempc, acentric)
